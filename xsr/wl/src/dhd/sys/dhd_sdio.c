 ...
 *
 * $Id: dhd_sdio.c,v 1.157.2.27.2.36.4.76 2010/05/25 18:14:08 Exp $
 */
	...
	uint16 func, uint bustype, void *regsva, osl_t * osh, void *sdh)
{
	...
	wake_lock_init(&bus->dhd->wake_lock, WAKE_LOCK_SUSPEND, "dhd_present");
#endif /*  LinuxVer */
#endif /* BCMLXSDMMC */
