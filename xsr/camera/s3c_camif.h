...
#else
#define CAMERA_MEM_SIZE       RESERVED_PMEM_JPEG // RESERVED_MEM_CAMERA
#endif
#define CAMERA_MEM_START      JPEG_RESERVED_PMEM_START
...
#define PREVIEW_DEFAULT_WIDTH		1024
#define PREVIEW_DEFAULT_HEIGHT		768
